...
def build_model(inp_size, hidden1, hidden2, num_classes):
    model = Sequential([
        Dense(hidden1, activation='relu', input_dim=(inp_size)),
...
def main():
    ...
    if DO_TRAINING:
        model = build_model(NUM_FEATURES, 30, 30, NUM_CLASSES)
        print(model.summary())
