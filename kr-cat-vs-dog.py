...
from tensorflow.keras.layers import (Input, Rescaling, Conv2D, BatchNormalization, Activation, add, Dropout,
...
def generate_datasets(image_size=IMAGE_SIZE, batch_size=BATCH_SIZE, val_split=0.2,
    ...
    if shuffle_train:
        train_dataset.shuffle(shuffle_size, seed=1337)
...
MODEL_SAVE_PATH = './model_states/kr-cats-vs-dogs.hd5'
